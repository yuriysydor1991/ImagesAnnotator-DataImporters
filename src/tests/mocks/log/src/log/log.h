#ifndef IMAGES_ANNOTATOR_DATA_IMPORTERS_PROJECT_LOGGER_SUBSYSTEM_DECLARATIONS_H
#define IMAGES_ANNOTATOR_DATA_IMPORTERS_PROJECT_LOGGER_SUBSYSTEM_DECLARATIONS_H
...
#endif  // IMAGES_ANNOTATOR_DATA_IMPORTERS_PROJECT_LOGGER_SUBSYSTEM_DECLARATIONS_H
