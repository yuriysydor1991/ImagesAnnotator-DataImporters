...
Скрипти секції [Швидкі скрипти побудови](/doc/sections/uk_UA/5-project-build/5-38-quick-build-scripts.md) виконують крок встановлення самостійно, коли вказано параметр `--install`, отож увесь цикл конфігурації, побудови і встановлення виконується однією командою:
