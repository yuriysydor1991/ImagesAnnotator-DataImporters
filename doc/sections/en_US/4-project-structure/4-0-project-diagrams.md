...
- `ImagesAnnotatorDataImporters012` - everything installed from [src/lib/facade/public](/src/lib/facade/public): `LibraryFacade`, `ILib`, `LibraryContext` with its nine layout descendants, `IImporter` and the consumer implemented `IImageSizeFacility`;
