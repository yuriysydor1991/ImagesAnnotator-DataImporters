...
The [src/lib/facade/public](/src/lib/facade/public) directory holds the whole installable interface of the library - nine headers, all in the `ImagesAnnotatorDataImporters011` namespace:
...
| [PlainTxtImportLibraryContext.h](/src/lib/facade/public/PlainTxtImportLibraryContext.h) | the `LibraryContext` of the plain text dataset layout |
| [Yolo4ImportLibraryContext.h](/src/lib/facade/public/Yolo4ImportLibraryContext.h) | the `LibraryContext` of the YOLO v4 (darknet) dataset layout |
| [PyTorchImportLibraryContext.h](/src/lib/facade/public/PyTorchImportLibraryContext.h) | the `LibraryContext` of the PyTorch Vision dataset layout |
...
So a new public class belongs in [src/lib/facade/public](/src/lib/facade/public) and has to be marked with `IADI_API`; every other component under [src](/src) stays private to the shared object and is reached through the abstract interfaces above.
